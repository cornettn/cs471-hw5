...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in legalActions:
            recordedQValue = self.getQValue(state, action)
            if maxValue is None:
                maxValue = recordedQValue
            elif recordedQValue > maxValue:
                maxValue = recordedQValue
    ...
    def computeActionFromQValues(self, state):
        ...
        bestActionInfo = None
        for action in legalActions:
            currActionInfo = (action, self.getQValue(state, action))

            if bestActionInfo is None:
                bestActionInfo = currActionInfo
                bestActions.append(currActionInfo[ACTION])
            elif currActionInfo[QVALUE] == bestActionInfo[QVALUE]:
                bestActions.append(currActionInfo[ACTION])
            elif currActionInfo[QVALUE] > bestActionInfo[QVALUE]:
                bestActions = list()
                bestActions.append(currActionInfo[ACTION])
    ...
    def getAction(self, state):
        ...
        """ Return the best action from our current knowledge """
